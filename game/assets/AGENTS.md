...
Los modelos 3D procesados viven bajo `models/vehicles/`; su fuente intacta, hash y auditoría permanecen en `references/vehicles/`. No usar la malla completa como colisión dinámica ni editar el `.glb` importado desde Godot; usar una escena contenedora.
