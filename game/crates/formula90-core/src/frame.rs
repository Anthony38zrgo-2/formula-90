...
pub struct AudioReadouts {
    ...
    /// Effective mechanical controls delivered to the audio mixer at this tick.
...
impl Default for CoreFrame {
    fn default() -> Self {
        Self {
            ...
            tire_gas_c: [0.0; 4],
            tire_wear_inner_fraction: [0.0; 4],
            tire_wear_center_fraction: [0.0; 4],
            tire_wear_outer_fraction: [0.0; 4],
            tire_wear_remaining_fraction: [0.0; 4],
            tire_wear_grip_scale: [0.0; 4],
            brake_disc_c: [0.0; 4],
            brake_rim_c: [0.0; 4],
            ...
            engine_block_temperature_celsius: 0.0,
            water_temperature_celsius: 0.0,
            oil_temperature_celsius: 0.0,
            engine_output_torque_newton_meters: 0.0,
            engine_mechanical_power_watts: 0.0,
            water_cooling_duct_opening: 0.0,
            oil_cooling_duct_opening: 0.0,
            water_cooling_mass_flow_kilograms_per_second: 0.0,
            oil_cooling_mass_flow_kilograms_per_second: 0.0,
            water_cooling_drag_force_newtons: 0.0,
            oil_cooling_drag_force_newtons: 0.0,
            ...
            available_engine_torque_fraction: 0.0,
            water_optimal_minimum_temperature_celsius: 0.0,
            water_optimal_maximum_temperature_celsius: 0.0,
            water_hot_derating_temperature_celsius: 0.0,
            water_critical_temperature_celsius: 0.0,
            oil_optimal_minimum_temperature_celsius: 0.0,
