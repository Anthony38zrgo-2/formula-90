...
fn bank_dir() -> std::path::PathBuf {
    // Crates live at game/crates/<crate>; the bank is at game/sounds/banks/commons.
...
#[test]
fn abi_version_canary_is_14() {
    assert_eq!(F90_CORE_ABI_VERSION, 14, "f90_core ABI must be v14");
}
