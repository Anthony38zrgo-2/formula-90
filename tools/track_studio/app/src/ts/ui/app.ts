...
export function bootstrap(): void {
  ...
  setupBuildPanel(byId("build") as HTMLButtonElement, byId("build-output"));
  setupReferencePanel(
    byId("reference"),
    byId("reference-add") as HTMLButtonElement,
    byId("reference-path") as HTMLInputElement,
    byId("reference-x") as HTMLInputElement,
    byId("reference-z") as HTMLInputElement,
    byId("reference-output"),
  );
  appState.subscribe(() => {
