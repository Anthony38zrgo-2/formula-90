...
export function setupReferencePanel(container, addButton, imagePathInput, xInput, zInput, output) {
...
export async function calibrateReference(layerId, imageDistancePx, realDistanceM, output) {
    try {
