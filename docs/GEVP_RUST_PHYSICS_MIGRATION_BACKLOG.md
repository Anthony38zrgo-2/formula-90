...
| `PHY-002` | P0 | `PHY-001` | `DONE` | **Configuración del Vehículo y Serialización JSON**: Definición de `VehicleConfig`, distribución de masas (45/55), momentos de inercia, centro de gravedad, curvas de torque normalizadas y relaciones de transmisión serializables con `serde`. |
