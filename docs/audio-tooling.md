...
> **Flujo vigente:** esta guía conserva referencias técnicas e históricas de DSP,
> pero ninguna herramienta debe escribir directamente en `game/sounds/`. Las
> fuentes viven en `source-assets/audio/`, los experimentos y candidatos en
> `scratch/audio/`, y el único cutover autorizado usa `promote_content.ps1`.
> Consulta `docs/audio-preview.md` y `docs/content-flow.md` antes de ejecutar
> ejemplos de remasterización de las secciones posteriores.
