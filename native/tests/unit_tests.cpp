...
int main(){
 check(choose_automatic_gear(1,8300,1,8200,4300,true,6)==2,"first_to_second");
 check(choose_automatic_gear(6,9000,1,8200,4300,true,6)==6,"sixth_limit");
 check(choose_automatic_gear(4,4000,.5,8200,4300,true,6)==3,"automatic_downshift");
 check(choose_automatic_gear(3,6000,.5,8200,4300,true,6)==3,"hysteresis_band");
 check(choose_automatic_gear(2,9000,1,8200,4300,false,6)==2,"minimum_shift_time");
 ...
 check(manual_shift_up(1,6)==2&&manual_shift_up(6,6)==6&&manual_shift_down(6)==5&&manual_shift_down(1)==1,"manual_gear_limits");
